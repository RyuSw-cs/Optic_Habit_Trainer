...
public class SecondStepReadyActivity extends AppCompatActivity {
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            Toast.makeText(SecondStepReadyActivity.this, "Camera2 API not supported on this device", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void requestCameraPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
            new AlertDialog.Builder(SecondStepReadyActivity.this)
                    .setMessage("R string request permission")
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(SecondStepReadyActivity.this,
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(SecondStepReadyActivity.this, "ERROR: Camera permissions not granted", Toast.LENGTH_LONG).show();
            }
        } else {
    ...
    private void showToast(final String text) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(SecondStepReadyActivity.this, text, Toast.LENGTH_SHORT).show();
            }
        });
    }
}
